...
const setFloat32 = (view: DataView, offset: number, value: number) => view.setFloat32(offset, value);
const setFloat64 = (view: DataView, offset: number, value: number) => view.setFloat64(offset, value);
